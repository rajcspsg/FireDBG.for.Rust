...
get_firedbg_version() {
    ...
    case "$_rustc_version" in
        ...
        rustc\ 1.81.*)
            ...
            ;;
        rustc\ 1.82.*)
            local _firedbg_version="1.82.0"
            ;;
        rustc\ 1.83.*)
            local _firedbg_version="1.83.0"
            ;;
        rustc\ 1.84.*)
            local _firedbg_version="1.84.0"
            ;;
        rustc\ 1.85.*)
            local _firedbg_version="1.85.0"
            ;;
        rustc\ 1.86.*)
            local _firedbg_version="1.86.0"
            ;;
        rustc\ 1.87.*)
            local _firedbg_version="1.87.0"
            ;;
        rustc\ 1.88.*)
            local _firedbg_version="1.88.0"
            ;;
        rustc\ 1.89.*)
            local _firedbg_version="1.89.0"
            ;;
        rustc\ 1.90.*)
            local _firedbg_version="1.90.0"
            ;;
        rustc\ 1.91.*)
            local _firedbg_version="1.91.0"
            ;;
        rustc\ 1.92.*)
            local _firedbg_version="1.92.0"
            ;;
        rustc\ 1.93.*)
            local _firedbg_version="1.93.0"
            ;;
        *)
